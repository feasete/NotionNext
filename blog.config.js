...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '晏衔青', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '当世界开始闪耀✨', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-7kozqyd5c-feasetes-projects.vercel.app/', // 网站地址
